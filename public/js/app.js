...
vue__WEBPACK_IMPORTED_MODULE_6__.default.use((vue_axios__WEBPACK_IMPORTED_MODULE_0___default()), (axios__WEBPACK_IMPORTED_MODULE_2___default()));
vue__WEBPACK_IMPORTED_MODULE_6__.default.use(vue_sweetalert2__WEBPACK_IMPORTED_MODULE_4__.default, optionsSweetalert2);
...
(axios__WEBPACK_IMPORTED_MODULE_2___default().defaults.baseURL) = "".concat(window.location.origin, "/");
...
var mutations = {
  ...
  assignTokenAxios: function assignTokenAxios() {
    vue__WEBPACK_IMPORTED_MODULE_2__.default.axios.defaults.headers.common.Authorization = "Bearer ".concat(state.access_token);
  },
