...
(axios__WEBPACK_IMPORTED_MODULE_2___default().defaults.baseURL) = "".concat(window.location.origin, "/api");
...
vue__WEBPACK_IMPORTED_MODULE_8__.default.mixin({
  methods: {
    compareObject: function compareObject(object, objectCompare) {
      if (_typeof(object) === 'object') {
        var sortObject = Object.keys(object).sort();
        var sortObjectCompare = Object.keys(objectCompare).sort();
        var response = null;
        ...
        if (response === null) {
          for (var i = 0; i < sortObject.length; i++) {
            if (sortObject[i] === sortObjectCompare[i] && object[sortObject[i]] !== objectCompare[sortObjectCompare[i]] && object[sortObject[i]] !== null) {
...
vue__WEBPACK_IMPORTED_MODULE_8__.default.use((vue_axios__WEBPACK_IMPORTED_MODULE_0___default()), (axios__WEBPACK_IMPORTED_MODULE_2___default()));
vue__WEBPACK_IMPORTED_MODULE_8__.default.use(vue_sweetalert2__WEBPACK_IMPORTED_MODULE_4__.default, optionsSweetalert2);
vue__WEBPACK_IMPORTED_MODULE_8__.default.use(vue_tailwind_picker__WEBPACK_IMPORTED_MODULE_6__.default);
...
/***/ "./resources/js/store/modules/session/index.js":
/*!*****************************************************!*\
  !*** ./resources/js/store/modules/session/index.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return new Promise(function (resolve) {
                vue__WEBPACK_IMPORTED_MODULE_2__.default.axios.post('auth/login', user).then(function (response) {
                  setTimeout(function () {
...
var mutations = {
  loginUserSuccess: function loginUserSuccess(state, data) {
  ...
  updateLocaleUser: function updateLocaleUser(state, user) {
    state.user = user;
    localStorage.setItem('user', JSON.stringify(state.user));
  },
  assignTokenAxios: function assignTokenAxios() {
    this.axios.defaults.headers.common['Authorization'] = "Bearer ".concat(state.access_token);
  },
...
/* harmony import */ var _modules_session__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/session */ "./resources/js/store/modules/session/index.js");
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_2__.default.Store({
  modules: {
    session: _modules_session__WEBPACK_IMPORTED_MODULE_0__.default
  }
});
...
!function(t,e){ true?module.exports=e():0}(this,function(){"use strict";return function(t,e,o){e.prototype.isToday=function(){var t=o();return this.format("YYYY-MM-DD")===t.format("YYYY-MM-DD")}}});
...
!function(e,t){ true?module.exports=t():0}(this,function(){"use strict";var e={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY h:mm A",LLLL:"dddd, MMMM D, YYYY h:mm A"};return function(t,n,o){var r=n.prototype,M=r.format;o.en.formats=e,r.format=function(t){void 0===t&&(t="YYYY-MM-DDTHH:mm:ssZ");var n=this.$locale().formats,o=function(t,n){return t.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,function(t,o,r){var M=r&&r.toUpperCase();return o||n[r]||e[r]||n[M].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,function(e,t,n){return t||n.slice(1)})})}(t,void 0===n?{}:n);return M.call(this,o)}}});
...
dayjs__WEBPACK_IMPORTED_MODULE_0___default().extend((dayjs_plugin_isToday__WEBPACK_IMPORTED_MODULE_1___default()));
...
dayjs__WEBPACK_IMPORTED_MODULE_0___default().extend((dayjs_plugin_localizedFormat__WEBPACK_IMPORTED_MODULE_4___default()));
dayjs__WEBPACK_IMPORTED_MODULE_0___default().extend((dayjs_plugin_advancedFormat__WEBPACK_IMPORTED_MODULE_5___default()));
dayjs__WEBPACK_IMPORTED_MODULE_0___default().extend((dayjs_plugin_isSameOrBefore__WEBPACK_IMPORTED_MODULE_6___default()));
dayjs__WEBPACK_IMPORTED_MODULE_0___default().extend((dayjs_plugin_isSameOrAfter__WEBPACK_IMPORTED_MODULE_7___default()));
...
var script = {
  ...
  data: function data() {
    var startDatepicker = this.startDate ? dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this.startDate, this.formatDate) : dayjs__WEBPACK_IMPORTED_MODULE_0___default()();
    ...
    var today = this.selectedDate && this.startDate < this.selectedDate
      ? dayjs__WEBPACK_IMPORTED_MODULE_0___default()(this.selectedDate, this.formatDate)
      : dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startDatepicker, this.formatDate);
...
/******/ 			if ({"resources_js_views_Layout_vue":1,"resources_js_views_Home_Home_vue":1,"resources_js_views_Session_Login_vue":1,"resources_js_views_Session_Register_vue":1,"resources_js_components_ModalTailwind_vue":1}[chunkId]) return "js/" + chunkId + ".js";
